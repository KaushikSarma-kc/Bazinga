from Bazinga_keys import PressKey, A, D, Space, ReleaseKey
import cv2
import numpy as np
import imutils
...
while True:
    ...
    colourLower = np.array([70, 74, 114])
    width = img.shape[1]
    height = img.shape[0]
    ...
    cv2.putText(img,'D',(440,30),cv2.FONT_HERSHEY_DUPLEX,1,(139,0,0))

    img = cv2.rectangle(img,(0,0),(width//2- 35,height//2 ),(0,255,0),1)
    cv2.putText(img,'A',(110,30),cv2.FONT_HERSHEY_DUPLEX,1,(139,0,0))
